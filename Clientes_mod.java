 ...
 * @author oscar
 */
public class Clientes_mod extends javax.swing.JFrame {
    private int Xmouse, Ymouse;
    private String Id, Nombre, Email, Tel, Dir;
    private boolean act;
    /**
    ...
    public void setClienteMod(String id, String mnombre, String memail, String mtelefono, String mdir, String mactivo) {
        this.Id = id;
        ID.setText(Id);
        this.Nombre = mnombre;
    ...
    private void initComponents() {
        ...
        Dir_field.setForeground(new java.awt.Color(204, 204, 204));
        ...
        Dir_field.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                Dir_fieldMousePressed(evt);
            }
        });
    ...
    private void login_btm2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_btm2MouseClicked
        ...
        if("".equals(Nombre_field.getText()) || "".equals(Dir_field.getText())){
            ...
            try {
                clientes.modificarCliente(Nombre, Nombre_field, Email_field, Tel_field, Dir_field, Act_rb);
                setVisible(false);
    ...
    private void Dir_fieldMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Dir_fieldMousePressed
        // TODO add your handling code here:
        
          
        
        Dir_field.setForeground(Color.black);
    }//GEN-LAST:event_Dir_fieldMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clientes_mod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clientes_mod().setVisible(true);
            }
        });
    }
