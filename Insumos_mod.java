...
public class Insumos_mod extends javax.swing.JFrame {
    ...
    public void setInsumoMod(String mid, String mnombre, String mcantidad, String mactivo) {
        ...
        this.Cantidad = mcantidad;
        Dir_field.setText(Cantidad);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insumos_mod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insumos_mod().setVisible(true);
            }
        });
    }
