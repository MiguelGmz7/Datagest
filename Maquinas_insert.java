 ...
 * @author oscar
 */
public class Maquinas_insert extends javax.swing.JFrame {
    int Xmouse, Ymouse;
    /**
     * Creates new form Clientes
     */
    public Maquinas_insert() throws SQLException {
        initComponents();
        id.setText(sacarId());
    }
    
    private String sacarId() throws SQLException{
        String sql = "select max(id) from maquinas;";
        String num = null;
        int val = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Maquinas_insert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(Maquinas_insert.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
