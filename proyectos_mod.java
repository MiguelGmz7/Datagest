 ...
 * @author oscar
 */
public class proyectos_mod extends javax.swing.JFrame {
    int Xmouse, Ymouse;
    boolean activo;
    /**
     ...
     */
    public proyectos_mod() throws SQLException {
        initComponents();
    ...
    public void setProyecto(String id, String nombre, String fecha_i, String fecha_f, String cliente, String maquina, String activo){
        ID.setText(id);
        Nombre.setText(nombre);
        Fechai.setText(fecha_i);
        Fechaf.setText(fecha_f);
        Clientes.setSelectedItem(cliente);
        Maquinas.setSelectedItem(maquina);
    ...
    private void login_btm2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_btm2MouseClicked
        ...
        try {
            new Cproyectos().modificarProyecto(ID, Nombre, Fechai, Fechaf, Clientes, Maquinas, Act_rb);
        } catch (SQLException ex) {
            Logger.getLogger(proyectos_mod.class.getName()).log(Level.SEVERE, null, ex);
        }
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proyectos_mod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new proyectos_mod().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(proyectos_mod.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
