 ...
 * @author oscar
 */
public class Maquinas_mod extends javax.swing.JFrame {
    ...
    public void setMaquinaMod(String id, String mnombre, String mproporcion, String mactivo) {
        this.id = id;
        ID.setText(this.id);
        this.Nombre = mnombre;
        Nombre_field.setText(Nombre);
        this.Email = mproporcion;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Maquinas_mod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Maquinas_mod().setVisible(true);
            }
        });
    }
