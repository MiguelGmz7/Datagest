 ...
 * @author oscar
 */
public class compras_mod extends javax.swing.JFrame {
    int Xmouse, Ymouse;
    private int maquina;
    /**
     * Creates new form Clientes
     */
    public compras_mod() throws SQLException {
        initComponents();
    ...
    private void fechaHoy() {                                            
        try {
            ...
            Logger.getLogger(compras_mod.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    public void setCompra(String id, String fecha, String provedor){
        //SimpleDateFormat formateador = new SimpleDateFormat("yyyy-MM-dd");
        
        ID.setText(id);
        Fecha.setText(fecha);
        Provedores.setSelectedItem(provedor);
    }
    ...
    private void login_btm2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_btm2MouseClicked
        ...
        new Ccompras().modificarCompra(ID, Fecha, Provedores);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(compras_mod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new compras_mod().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(compras_mod.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
