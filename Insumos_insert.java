 ...
 * @author oscar
 */
public class Insumos_insert extends javax.swing.JFrame {
    int Xmouse, Ymouse;
    /**
     * Creates new form Clientes
     */
    public Insumos_insert() throws SQLException {
        initComponents();
        id.setText(sacarId());
    }
    private String sacarId() throws SQLException{
        String sql = "select max(material_id) from insumos_en_stock;";
        String num = null;
        int val = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insumos_insert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(Insumos_insert.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
